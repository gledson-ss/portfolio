  ...
  return (
    <St.Container>
      <St.InformationBlock>
        <St.TextContainer>
          <St.Text>
            Sou graduando em Engenharia de Computação, no Instituto Federal da
            ...
            embarcados e automação, programando microcontroladores, podendo ser
            para diversas aplicações. Custumo trabalhar utilizando diversas
            ferramentas para boas práticas e maneiras otimizadas de organizar
            meu trabalho, utilizando sempre o git e github para versionamento de
            código de projetos ou somente para estudo, além disso, ferramentas
            para organizar o dia a dia, como notion, google agendas e etc.
          </St.Text>
        </St.TextContainer>
        <St.VectorContainer>
